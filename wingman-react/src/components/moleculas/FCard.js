                ...
                <th scope="row">
                    <div class="media align-items-center">
                        ...
                        <div class="media-body">
                            <span class="h6 mb-0">FIT
                            </span>
                            <span class="text-muted">Codebusters</span>
                        </div>
                    </div>
                </th>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">ISE
                            </span>
                            <span class="text-muted">Scromnye majory</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">BS
                            </span>
                            <span class="text-muted">Show off</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">KMA
                            </span>
                            <span class="text-muted">Vodolei</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">RECMC
                            </span>
                            <span class="text-muted">Eto ne professiya</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">FEOGI
                            </span>
                            <span class="text-muted">Budushee ne za vami</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
            ...
            <tr class="bg-white">
                <th scope="row">
                    <div class="media align-items-center">
                        <img alt="Image" src="" class="avatar" />
                        <div class="media-body">
                            <span class="h6 mb-0">SCE
                            </span>
                            <span class="text-muted">Vy kto?</span>
                        </div>
                    </div>
                </th>
                <td>daniel.cameron@wingman.co</td>
